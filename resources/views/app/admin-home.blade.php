    ...
    <section class="border border-danger">
        <div class="card">
            ...
            <div class="card-body">
                ...
                laudantium tempore exercitationem, expedita aspernatur sed officia asperiores undetempora maxime odio
                reprehenderit distinctio incidunt! Vel aspernatur dicta consequatur!
            </div>
        </div>
    </section>
@endsection
